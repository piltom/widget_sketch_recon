...
dataset_df=pd.read_pickle("dataset_img_hough13_fullsize.pkl").dropna(axis=1)
print(dataset_df)
X=dataset_df.drop(['target', 'filename'], axis=1)
y=dataset_df['target']
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.10, random_state=11, stratify=y)
